...
void loop()
{
   SetMotorMode1(2000,2000,2000,2000);       //Forward
   usleep(1000);
    SetMotorMode1(-2000,-2000,-2000,-2000);   //Back
    usleep(1000);
   SetMotorMode1(-500,-500,2000,2000) ;      //Left
    usleep(1000);
   SetMotorMode1(2000,2000,-500,-500);      //Right
    usleep(1000);
   SetMotorMode1(0,0,0,0);            // Stop
}
